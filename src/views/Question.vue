<template>
  <div>
    <div class="editorCode" style="text-align: left;">
      <!-- 编辑器挂载的地方 -->
...
<script>
  ...
  // 但 vue 貌似没有无法在实例初始化后再动态加载对应 JS ，所以此处才把对应的 JS 提前引入 import 'codemirror/mode/clike/clike.js' import 'codemirror/mode/markdown/markdown.js'
